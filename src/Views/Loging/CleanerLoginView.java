...
import Views.Employee.CleanerDashboardView;
...
public class CleanerLoginView extends JFrame {
    ...
    private void login() {
        ...
        for (Cleaner cleaner : Cleaner.getCleanerExtent()) {
            ...
            if (cleaner.getPersonName().equalsIgnoreCase(name)
                    &&
                    cleaner.getPeronSurname().equalsIgnoreCase(surname)
                    &&
                    cleaner.getPersonDateOfBirth().equals(birthDate)
                    &&
                    cleaner.getPersonSex() == sex) {
